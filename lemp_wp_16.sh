...
apt-get -y install php7.0-fpm php7.0-mcrypt php7.0-curl php7.0-cli php7.0-mysql php7.0-gd php7.0-intl php7.0-xsl libperl-dev libpcre3 libpcre3-dev libssl-dev php7.0-gd libgd2-xpm-dev libgeoip-dev libgd2-xpm-dev nginx
